...
class DataReductionGUI(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        scienceframe = ttk.Frame(mainframe)
        ...
        compdiventry = ttk.Entry(divframe, validate="focusout", textvariable=compdivvar)
        ...
        sciencediventry = ttk.Entry(divframe, validate="focusout", textvariable=sciencedivvar)
        ...
        testbtn = ttk.Button(controlframe, text="Reduce Data", command=lambda:
        data_reduction(
